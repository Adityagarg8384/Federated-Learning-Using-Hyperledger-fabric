...
import {getAffiliation,getCCP,getRegisteredUser,getWalletPath} from './helper.js';

export const  query = async (channelName, chaincodeName, args, fcn, username, org_name) => {
